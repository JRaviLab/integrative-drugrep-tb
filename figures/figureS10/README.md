...
To reproduce the baseline comparison and Figure S10, run the notebook:
```
figures/figureS10/suppl_baseline_comparison.ipynb
```
...
- visualization of results used to generate Figure S10
